...
1- The previous chapter introduced the standard function Math.min that returns its smallest argument. 
We can build something like that now. Write a function min that takes two arguments and returns their 
minimum.
...
/*
2- We’ve seen that % (the remainder operator) can be used to test whether a number is even or odd by 
...
/*
3- You can get the Nth character, or letter, from a string by writing "string"[N]. The returned value will 
